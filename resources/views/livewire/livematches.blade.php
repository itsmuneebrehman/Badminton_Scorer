...
class extends Component
{
    ...
    public function mount(){
        $this->matches = MatchModel::with('teams')->where('status', 'ongoing')->get();
    }
}; ?>
                ...
                <div class="flex justify-between h-16">
                    <div class="flex items-center">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <h1 class="text-xl font-bold text-gray-900 dark:text-white">Live Matches</h1>
                                <p class="text-xs text-gray-500 dark:text-gray-400">See all live badminton matches
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="match-card bg-white dark:bg-gray-800 rounded-xl shadow-sm border-l-4 border-red-500 border border-gray-200 dark:border-gray-700 p-6 hover:shadow-lg transition-all"
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex space-x-3">
                                <a 
                                @if (auth()->check())
                                    href={{ route('match.view', $match->id) }}
                                @else
                                    href={{ route('guest.view', $match->id) }}
                                @endif
